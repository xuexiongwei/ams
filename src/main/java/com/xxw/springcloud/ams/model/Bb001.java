 ...
 *
 */
public class Bb001 implements Serializable {
	...
	public String getBuldStatus() {
		return buldStatus;
	}

	public void setBuldStatus(String buldStatus) {
		this.buldStatus = buldStatus;
	}
